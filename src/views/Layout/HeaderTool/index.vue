<template>
    <div class="header-tool">
        ...
        <a-dropdown @select="handlerLog($event, 1)" class="animate__animated animate__flipInX">
            <!-- 修改头像路径为 assets/dd.jpg -->
            <img class="user-icon animate__animated animate__fadeInUp animate__delay-1s" src="@/assets/dd.jpg" alt="User Avatar" />
            <template #content>
                <a-doption value="user">用户: {{ user }}</a-doption>
                <a-doption value="level">等级: svip</a-doption>
